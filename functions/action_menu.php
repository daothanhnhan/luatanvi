    ...
    public function setUrlFriendly_byType($id_menu,$lang){
        ...
        switch ($rowMenu[$this->nameColTypeId_menu]) {
            ...
            case '5': //danh muc tin tuc
                ...
                $url = '/n/'.$rowItemLanguage[$this->nameColUrlNewsCat_newsCatLanguage];
                break;
            case '7': //bai viet tin tuc
                ...
                $url = '/n/'.$rowItemLanguage[$this->nameColUrlNews_newsLanguage];
                break;
            ...
            case '13': // page
                ...
                $url = '/page/'.$rowItemLanguage[$this->nameColUrl_pageLanguage];
                break;
    ...
    public function showMenu_byMultiLevel_mainMenuCarrot($list_menu,$valParent_menu = 0,$lang, $level = 0){
        ...
        if ($cate_child) {
            if ($level == 0) {
                ...
                if ($level == 1) {echo '<i class="fa fa-caret-up" aria-hidden="true"></i>';}
            }
            ...
            if ($level == 0) {
                echo '<a href="tel:" class="hotline"><i class="fa fa-phone" aria-hidden="true"></i> 098.1214.789 </a>';
            }
            echo '</ul>';
        }
    }
