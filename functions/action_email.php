...
class action_email 
{
        function email_send ($email_to, $title = "", $content = "") {
                $nFrom = "vtrader.vn";    //mail duoc gui tu dau, thuong de ten cong ty ban
                $mFrom = 'vtrader.vn@gmail.com';  //dia chi email cua ban 
                $mPass = 'Tam1beo2';       //mat khau email cua ban
                ...
                $mail->AddReplyTo('vtrader.vn@gmail.com', 'em'); //khi nguoi dung phan hoi se duoc gui den email nay
