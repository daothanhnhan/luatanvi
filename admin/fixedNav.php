<div class="fixedLeft">
 ...
 -->
         ...
         <!--    <li><a href="index.php?page=nhan-tai-lieu" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhận tài liệu</a>
            </li>

            <li><a href="index.php?page=bang-khoa-hoc" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Lịch khai giảng</a>
            </li> -->
            <?php } ?>
