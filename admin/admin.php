        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    ///////////// nhan tai lieu ///////////
                    case "nhan-tai-lieu":
                        include_once("template/nhan-tai-lieu.php");
                        break;
                    ///////////// bảng khóa học ///////////
                    case "bang-khoa-hoc":
                        include_once("template/bang-khoa-hoc/bang-khoa-hoc.php");
                        break;
                    case "them-bang-khoa-hoc":
                        include_once("template/bang-khoa-hoc/them-bang-khoa-hoc.php");
                        break;
                    case "sua-bang-khoa-hoc":
                        include_once("template/bang-khoa-hoc/sua-bang-khoa-hoc.php");
                        break;
                    case "xoa-bang-khoa-hoc":
                        include_once("template/bang-khoa-hoc/xoa-bang-khoa-hoc.php");
                        break;
                    ///////////// Default /////////////////
                    default:
