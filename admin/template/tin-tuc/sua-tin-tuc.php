...
<form action="" method="post" id="updateNews" enctype="multipart/form-data">
    ...
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            <span class="titLeftNCP">Banner</span>
        ...
        <div class="boxNodeContentPage">
            <div id="wrapper">
                ...
                <?php 
                    if ($row['news_img_sub'] != '') {
                    ?>
                        <img src="../images/<?= $row['news_img_sub']?>" class="img-responsive" alt="Image" width="200">
                        <input type="hidden" name="news_img_sub" value="<?= $row['news_img_sub']?>">
                    <?php
                    }
                ?>                
                </div>
    ...
    <button type="submit" class="btn btnDelete" id="deleteNews" data-id="<?= $news_id?>" data-action="deleteNews" <?php echo ($_SESSION['admin_role']==2)?'':'';?> >Xóa</button>
</form>
